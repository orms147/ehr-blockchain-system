...
> - **Thứ tự còn lại**: Ch5 (envelope/cascade/trusted-contact/relayer/threat — phần còn lại) → Phụ lục B → Ch3 → (Ch6/Ch1/Tóm tắt phần code còn) → Ch7 (orphan cite) → Sơ đồ. Backup: `BaoCao_preCh4_20260623_2203.tgz`.
