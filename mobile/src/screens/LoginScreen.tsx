    ...
    const handleWeb3Login = async (providerKey?: ProviderKey) => {
        ...
        try {
            ...
            if (error?.code === 'BACKEND_UNREACHABLE') {
                ...
                // friendlyProviderError map OAuth codes (access_denied,
                // popup_closed...) sang tiếng Việt — tránh leak raw English
                // ("Login failed, access_denied") ra UI VN. User feedback A6.
