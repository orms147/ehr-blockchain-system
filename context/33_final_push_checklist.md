...
> - **Thứ tự còn lại**: Ch3 (m17-m20 lib/crypto minor) → Ch7 (orphan cite \cite 3 luật + qd586 url) → Sơ đồ (#10 render .puml + sửa nội dung). Backups: `BaoCao_preCh4_20260623_2203.tgz`, `BaoCao_postLegal_20260623.tgz`.
