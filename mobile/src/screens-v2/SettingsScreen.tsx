        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: EHR_SURFACE }} edges={['bottom', 'left', 'right']}>
            <ScrollView contentContainerStyle={{ paddingTop: 8, paddingBottom: 40 }} showsVerticalScrollIndicator={false}>
                ...
                <View style={{ paddingHorizontal: 20, marginBottom: 18 }}>
                    <ViCard padding={0}>
                        <Tile
                            icon={<UserIcon size={18} color={EHR_ON_SURFACE_VARIANT} />}
                ...
                <View style={{ paddingHorizontal: 20, marginBottom: 18 }}>
                    <ViCard padding={0}>
                        <Tile
                            icon={<HelpCircle size={18} color={EHR_ON_SURFACE_VARIANT} />}
                ...
                <View style={{ paddingHorizontal: 20 }}>
                    <ViCard padding={0}>
                        <Tile
                            icon={<LogOut size={18} color={EHR_PRIMARY} />}
                            title="Đăng xuất"
...
function Tile({
    ...
    const fg = danger ? EHR_PRIMARY : EHR_ON_SURFACE;
    ...
    return (
        ...
        >
            <View style={{ width: 20, alignItems: 'center' }}>
                <Fingerprint size={18} color={EHR_ON_SURFACE_VARIANT} />
            </View>
...
// Suppress unused import warning for EHR_TERTIARY (kept available for future
